...
@section('container')
    <div class="container-fluid p-0">
        <h1 class="h3">Daftar Lowongan Pekerjaan</h1>
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-body">
                                    ...
                                    @foreach ($lowongans as $lowongan)
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('storage/' . $lowongan->gambar) }}"
                                                    alt="gambar-perusahaan" style="width: 250px"; height="200px"></td>
                                            ...
                                            <td>
                                                ...
                                                @if ($lowongan->pendaftars->contains('user_id', Auth::id()))
                                                    <button type="button" class="btn btn-danger"><i class="bi bi-x-square">
                                                        </i>Anda sudah mendaftar</button>
                                                @else
                                                    @if ($diff->days > 0)
                                                        <a href="/dashboard/lowongan-tersedia/daftar/{{ $lowongan->slug }}"
                                                            class="btn btn-success"><i class="bi bi-person-plus"></i></a>
                                                    @else
                                                        <button type="button" class="btn btn-danger"><i
                                                                class="bi bi-x-square"> </i>Pendaftaran Telah
                                                            Berakhir</button>
                                                    @endif
                                                @endif
                                            </td>
