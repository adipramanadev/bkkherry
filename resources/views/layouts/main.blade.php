...
<head>
    ...
    <link href="{{ asset('FlexStart/assets/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet">
    <link href="{{ asset('FlexStart/assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
    <link href="{{ asset('FlexStart/FlexStart/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
